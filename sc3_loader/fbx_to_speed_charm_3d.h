...
fbx_to_sc3_si_strap void convert_fbx_vec4_to_sc3_vec4(SGG_Vector4 * dst_vec4, ufbx_quat * src_vec4){
...
void convert_fbx_attribute_to_sc3_attribute(Speed_Charm_3D_Mesh * sc3_mesh, Speed_Charm_3D_Bone_Map_Cache * bone_list, ufbx_mesh * fbx_mesh, ufbx_skin_deformer * fbx_skin, sc_uint fbx_triangle_num, Speed_Charm_3D_Skin_Attr * skin_attribute);
_EXTERN_C_END_
